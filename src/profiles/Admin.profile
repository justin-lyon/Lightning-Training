...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>LTNG_Train</application>
    ...
    <classAccesses>
        <apexClass>ContactSearchAuraService</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <classAccesses>
        <apexClass>NYT_ArticleSearchAuraService</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
